...
public class ProfesseurService {
	...
	public ProfesseurService() {
		this.professeurDAO = new ProfesseurDAO(DatabaseManager.getConnection());
	}
	...
	public Professeur getProfesseurParUserID(int id) {
		return professeurDAO.getProfesseurByUserId(id);
	}
